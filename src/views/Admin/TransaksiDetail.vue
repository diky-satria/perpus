            ...
            <div class="col-md-4">
              <table class="table-sm">
                ...
                <tr>
                  <td>NIM</td>
                  <td>:</td>
                  <td>{{ transaksis.nim }}</td>
                </tr>
                <tr>
                  <td>Jurusan</td>
                  <td>:</td>
                  <td>{{ transaksis.jurusan }}</td>
                </tr>
                <tr>
                  <td>Semester</td>
                  <td>:</td>
                  <td>{{ transaksis.semester }}</td>
                </tr>
                <tr>
                  <td>Kelas</td>
                  <td>:</td>
                ...
                <tr>
                  ...
                  <td>
                    <div v-if="denda(transaksis.tgl_pengembalian) > 0" style="color:red;font-weight:bold;">
                      <div class="float-left">{{ denda(transaksis.tgl_pengembalian) }} hari | </div> <FormatRupiah :angka="denda(transaksis.tgl_pengembalian) * 1000 * transaksis.jumlah" :prefix="' Rp. '" class="float-left ml-1"/>
                    </div>
                    <div v-else:>---</div>
                  </td>
                </tr>
