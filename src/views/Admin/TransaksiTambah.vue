          ...
          <div class="row">
            ...
            <div class="col-md">
              <form @submit.prevent="update">
                ...
                <button type="submit" class="btn btn-sm btn-primary btn-block float-right d-flex justify-content-center" id="btn-lanjut">
                  <div>
                    Lanjutkan
                  </div>
                  <div>
...
export default {
  setup(){
    ...
    const update = async () => {
      let btn = document.getElementById('btn-lanjut')
      try{  
