  ...
  <div>
    <div class="container">
        <div class="d-flex justify-content-between">
          <div>
            <div class="tombol-modify">Tambah Mahasiswa</div>
          </div>
              ...
              <div class="row">
                <div class="col-md">
                  <div class="form-group">
                      <label>NIM</label>
                      <input type="text" v-model="form.nim" class="form-control">
                      <span class="text-danger" v-if="errors['nim']">{{ errors['nim'][0] }}</span>
                  </div>
                  <div class="form-group">
                      <label>Nama</label>
                ...
                <div class="col-md">
                  <div class="form-group">
                      ...
                      <span class="text-danger" v-if="errors['jurusan_id']">{{ errors['jurusan_id'][0] }}</span>
                  </div>
                  <div class="form-group">
                      ...
                      <span class="text-danger" v-if="errors['semester_id']">{{ errors['semester_id'][0] }}</span>
                  </div>
                  <div class="form-group">
                      <label>Kelas</label>
                  ...
                  <!-- <div class="form-group">
                    <input type="file" @change="ubahGambar" accept="image/*" class="form-control">
                  </div> -->
                  <button type="submit" class="btn btn-sm btn-primary float-right d-flex" id="btn-mahasiswa">
                    <div>
                      Tambah
                    </div>
                    <div>
...
export default {
  setup(){
    ...
    const getSemester = async () => {
      let response = await axios.get('api/semester')
    ...
    const addMahasiswa = async () => {
      let btn = document.getElementById('btn-mahasiswa')
      try{
