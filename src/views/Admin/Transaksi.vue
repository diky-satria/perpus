              ...
              <tr v-for="(trans, index) in transaksis" :key="index">
                ...
                <td>
                  <div v-if="denda(trans.tgl_pengembalian) > 0" style="color:red;font-weight:bold;">
                    <div class="float-left">{{ denda(trans.tgl_pengembalian) }} hari |</div> <FormatRupiah :angka="denda(trans.tgl_pengembalian) * 1000 * trans.jumlah" :prefix="'Rp. '" class="ml-1 float-left"/>
                  </div>
                  <div v-else:>---</div>
                </td>
                <td class="d-flex">
